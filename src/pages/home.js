  ...
  render() {
    ...
    return (
      <Grid container className={clsx([classes.content], {
        ...
        <p style={{ fontSize: 36, color: "#4a54f1", fontfamily: fantasy, textAlign: "top", paddingTop: "10px" }}>A PSW Hiring Platform</p>
        <div>
      <img src="https://blog.academyoflearning.com/wp-content/uploads/2017/05/personal-support-worker-careers-1.png" alt="image" />
    </div>
      </Grid>
    );
  }
